...
export default async function SlimePage({
  ...
  const { id, name, image, slimepedia, slimes, foods } =
                  ...
                  <ul>
                    {slimes.map((slime) => (
                      <Text key={slime.name} color='gray'>
                        <Link href={`/info/slime/${slime.id}`} className='rt-Link' data-accent-color='ruby'>
                          <li>{slime.name}</li>
                        </Link>
                      </Text>
                    ))}
                  ...
                  <ul>
                    {foods.map((food) => (
                      <Text key={food.name} color='gray'>
                        <Link href={`/info/food/${food.id}`} className='rt-Link' data-accent-color='ruby'>
                          <li>{food.name}</li>
                        </Link>
                      </Text>
                    ))}
